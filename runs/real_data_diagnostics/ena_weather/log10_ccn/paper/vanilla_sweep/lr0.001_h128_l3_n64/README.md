...
```bash
python experiments/real_data_diagnostic.py --engression-model vanilla --target ccn --log-ccn --split paper --max-samples all --seq-stride 1 --train-size all --test-size all --epochs 80 --batch-size 256 --lr 0.001 --hidden-dim 128 --num-layer 3 --noise-dim 64 --prediction-samples 400 --device cuda --out-dir runs/real_data_diagnostics/ena_weather/log10_ccn/paper/vanilla_sweep/lr0.001_h128_l3_n64 --skip-assertions
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.154742` |
| median abs error | `0.180216` |
| 90% interval coverage | `0.289130` |
| 50% interval coverage | `0.118012` |
| mean 90% interval width | `0.175346` |
| mean 50% interval width | `0.072038` |
