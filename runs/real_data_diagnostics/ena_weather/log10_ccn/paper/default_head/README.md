...
```bash
python experiments/real_data_diagnostic.py --engression-model lstm --target ccn --log-ccn --split paper --max-samples all --seq-stride 1 --train-size all --test-size all --epochs 120 --batch-size 256 --hidden-dim 192 --noise-dim 96 --num-layer 3 --lr 0.003 --weight-decay 0.0 --prediction-samples 800 --checkpoint-every 25 --device cuda --out-dir runs/real_data_diagnostics/ena_weather/log10_ccn/paper/default_head --skip-assertions
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.126070` |
| median abs error | `0.176151` |
| 90% interval coverage | `0.887888` |
| 50% interval coverage | `0.479503` |
| mean 90% interval width | `0.689731` |
| mean 50% interval width | `0.266480` |
