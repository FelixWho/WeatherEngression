...
```bash
python experiments/real_data_diagnostic.py --target ccn --log-ccn --split paper --max-samples all --train-size all --test-size all --seq-stride 4 --epochs 200 --batch-size 256 --hidden-dim 192 --noise-dim 96 --num-layer 3 --stonet-head --lr 0.001 --weight-decay 0.0001 --prediction-samples 800 --checkpoint-every 10 --device cuda --skip-assertions --out-dir runs/real_data_diagnostics/log10_ccn/paper/sweep/D_lowlr_stonet
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.153230` |
| median abs error | `0.183037` |
| 90% interval coverage | `0.378571` |
| 50% interval coverage | `0.161180` |
| mean 90% interval width | `0.219758` |
| mean 50% interval width | `0.089632` |
