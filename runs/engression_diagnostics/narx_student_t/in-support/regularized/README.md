# Engression Diagnostic Run: NARX Student-t / in-support / regularized
...
```bash
python experiments/engression_diagnostic.py --model narx_student_t --engression-model regularized -d 12 --num-samples 5000 --train-size 4000 --test-size 500 --split in-support --epochs 120 --batch-size 512 --hidden-dim 192 --noise-dim 96 --lr 0.003 --weight-decay 0.003 --prediction-samples 800 --skip-assertions
```
...
| q50 MAE | `0.126160` |
| q95 MAE | `0.189523` |
| predicted 90% interval coverage | `0.866000` |
| true 90% interval coverage on realized y | `0.920000` |
| mean predicted 90% interval width | `1.304359` |
