...
```bash
python experiments/real_data_diagnostic.py --engression-model vanilla --target ccn --log-ccn --split paper --max-samples all --seq-stride 1 --train-size all --test-size all --epochs 120 --batch-size 256 --hidden-dim 192 --noise-dim 96 --num-layer 3 --lr 0.003 --prediction-samples 800 --device cuda --skip-assertions
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.150200` |
| median abs error | `0.178680` |
| 90% interval coverage | `0.360559` |
| 50% interval coverage | `0.143478` |
| mean 90% interval width | `0.206983` |
| mean 50% interval width | `0.084536` |
