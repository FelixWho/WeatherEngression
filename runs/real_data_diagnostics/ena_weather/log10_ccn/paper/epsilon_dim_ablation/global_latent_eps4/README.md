...
```bash
python experiments/real_data_diagnostic.py --mat-path data_generation/weather_data.mat --engression-model lstm --global-latent-noise --target ccn --log-ccn --split paper --max-samples all --seq-stride 1 --train-size all --test-size all --epochs 100 --early-stop-patience 12 --batch-size 128 --lr 0.003 --hidden-dim 128 --num-layer 3 --noise-dim 4 --prediction-samples 400 --seed 2026 --no-oos --checkpoint-every 10 --device mps --out-dir runs/real_data_diagnostics/ena_weather/log10_ccn/paper/epsilon_dim_ablation/global_latent_eps4 --skip-assertions --verbose
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.123144` |
| median abs error | `0.170216` |
| 90% interval coverage | `0.825776` |
| 50% interval coverage | `0.446273` |
| mean 90% interval width | `0.603653` |
| mean 50% interval width | `0.241836` |
