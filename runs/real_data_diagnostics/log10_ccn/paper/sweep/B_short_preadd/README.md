...
```bash
python experiments/real_data_diagnostic.py --target ccn --log-ccn --split paper --max-samples all --train-size all --test-size all --seq-stride 4 --epochs 120 --batch-size 256 --hidden-dim 192 --noise-dim 96 --num-layer 3 --pre-additive --index-dim 96 --lr 0.003 --weight-decay 0.0 --prediction-samples 800 --checkpoint-every 10 --device cuda --skip-assertions --out-dir runs/real_data_diagnostics/log10_ccn/paper/sweep/B_short_preadd
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.154883` |
| median abs error | `0.174977` |
| 90% interval coverage | `0.265217` |
| 50% interval coverage | `0.111801` |
| mean 90% interval width | `0.137364` |
| mean 50% interval width | `0.055747` |
