...
```bash
python experiments/engression_diagnostic.py --engression-model lstm --model narx_student_t -d 12 --num-samples 5000 --train-size 4000 --test-size 500 --window 12 --epochs 40 --batch-size 512 --hidden-dim 192 --noise-dim 96 --lr 0.003 --weight-decay 0 --prediction-samples 800 --skip-assertions --plot-out runs/engression_diagnostics/narx_student_t/in-support/lstm_e40_wd0/posterior_bands.png
```
...
| Metric | Value |
|---|---:|
| mean quantile MAE | `0.137855` |
| q05 MAE | `0.152593` |
| q50 MAE | `0.102062` |
| q95 MAE | `0.158908` |
| predicted 90% interval coverage | `0.886000` |
| true 90% interval coverage on realized y | `0.920000` |
| mean predicted 90% interval width | `1.242438` |
| mean true 90% interval width | `1.295003` |
| width ratio | `0.959409` |
