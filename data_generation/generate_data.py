...
# Allow running this module as a script (``python data_generation/generate_data.py``)
# in addition to ``python -m data_generation.generate_data``: put the repo root on
# the path so the absolute ``data_generation.*`` imports below resolve.
