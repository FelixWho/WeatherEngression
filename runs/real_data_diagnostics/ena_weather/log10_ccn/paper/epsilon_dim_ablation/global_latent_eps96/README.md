...
```bash
python experiments/real_data_diagnostic.py --mat-path data_generation/weather_data.mat --engression-model lstm --global-latent-noise --target ccn --log-ccn --split paper --max-samples all --seq-stride 1 --train-size all --test-size all --epochs 100 --early-stop-patience 12 --batch-size 128 --lr 0.003 --hidden-dim 128 --num-layer 3 --noise-dim 96 --prediction-samples 400 --seed 2026 --no-oos --checkpoint-every 10 --device mps --out-dir runs/real_data_diagnostics/ena_weather/log10_ccn/paper/epsilon_dim_ablation/global_latent_eps96 --skip-assertions --verbose
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.125627` |
| median abs error | `0.174704` |
| 90% interval coverage | `0.935404` |
| 50% interval coverage | `0.571429` |
| mean 90% interval width | `0.844910` |
| mean 50% interval width | `0.331005` |
