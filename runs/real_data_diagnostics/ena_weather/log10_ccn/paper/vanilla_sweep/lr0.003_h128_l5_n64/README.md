...
```bash
python experiments/real_data_diagnostic.py --engression-model vanilla --target ccn --log-ccn --split paper --max-samples all --seq-stride 1 --train-size all --test-size all --epochs 80 --batch-size 256 --lr 0.003 --hidden-dim 128 --num-layer 5 --noise-dim 64 --prediction-samples 400 --device cuda --out-dir runs/real_data_diagnostics/ena_weather/log10_ccn/paper/vanilla_sweep/lr0.003_h128_l5_n64 --skip-assertions
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.157729` |
| median abs error | `0.183820` |
| 90% interval coverage | `0.311180` |
| 50% interval coverage | `0.118323` |
| mean 90% interval width | `0.181064` |
| mean 50% interval width | `0.074222` |
