...
```bash
python experiments/engression_diagnostic.py --engression-model lstm --model narx_student_t -d 12 --num-samples 5000 --train-size 4000 --test-size 500 --window 12 --epochs 40 --batch-size 512 --hidden-dim 192 --noise-dim 96 --lr 0.003 --weight-decay 0.003 --prediction-samples 800 --skip-assertions --plot-out runs/engression_diagnostics/narx_student_t/in-support/lstm_e40_wd003/posterior_bands.png
```
...
| Metric | Value |
|---|---:|
| mean quantile MAE | `0.148212` |
| q05 MAE | `0.168822` |
| q50 MAE | `0.091681` |
| q95 MAE | `0.184133` |
| predicted 90% interval coverage | `0.912000` |
| true 90% interval coverage on realized y | `0.920000` |
| mean predicted 90% interval width | `1.452991` |
| mean true 90% interval width | `1.295003` |
| width ratio | `1.121998` |
