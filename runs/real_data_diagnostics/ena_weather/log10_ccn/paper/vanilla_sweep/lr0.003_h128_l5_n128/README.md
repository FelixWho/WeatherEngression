...
```bash
python experiments/real_data_diagnostic.py --engression-model vanilla --target ccn --log-ccn --split paper --max-samples all --seq-stride 1 --train-size all --test-size all --epochs 80 --batch-size 256 --lr 0.003 --hidden-dim 128 --num-layer 5 --noise-dim 128 --prediction-samples 400 --device cuda --out-dir runs/real_data_diagnostics/ena_weather/log10_ccn/paper/vanilla_sweep/lr0.003_h128_l5_n128 --skip-assertions
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.152072` |
| median abs error | `0.182607` |
| 90% interval coverage | `0.378882` |
| 50% interval coverage | `0.149689` |
| mean 90% interval width | `0.226465` |
| mean 50% interval width | `0.090172` |
