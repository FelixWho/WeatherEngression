...
```bash
python experiments/real_data_diagnostic.py --target ccn --log-ccn --split paper --max-samples all --train-size all --test-size all --seq-stride 4 --epochs 150 --batch-size 256 --hidden-dim 256 --noise-dim 128 --num-layer 3 --stonet-head --lr 0.003 --weight-decay 0.0001 --prediction-samples 800 --checkpoint-every 10 --device cuda --skip-assertions --out-dir runs/real_data_diagnostics/log10_ccn/paper/sweep/C_bigreg_stonet
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.137747` |
| median abs error | `0.178761` |
| 90% interval coverage | `0.572360` |
| 50% interval coverage | `0.263975` |
| mean 90% interval width | `0.362733` |
| mean 50% interval width | `0.147466` |
