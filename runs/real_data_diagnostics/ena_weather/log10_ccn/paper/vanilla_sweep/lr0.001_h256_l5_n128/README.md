...
```bash
python experiments/real_data_diagnostic.py --engression-model vanilla --target ccn --log-ccn --split paper --max-samples all --seq-stride 1 --train-size all --test-size all --epochs 80 --batch-size 256 --lr 0.001 --hidden-dim 256 --num-layer 5 --noise-dim 128 --prediction-samples 400 --device cuda --out-dir runs/real_data_diagnostics/ena_weather/log10_ccn/paper/vanilla_sweep/lr0.001_h256_l5_n128 --skip-assertions
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.154255` |
| median abs error | `0.176779` |
| 90% interval coverage | `0.262733` |
| 50% interval coverage | `0.107143` |
| mean 90% interval width | `0.153675` |
| mean 50% interval width | `0.062830` |
