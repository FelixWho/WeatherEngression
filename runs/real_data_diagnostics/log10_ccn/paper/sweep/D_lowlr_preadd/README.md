...
```bash
python experiments/real_data_diagnostic.py --target ccn --log-ccn --split paper --max-samples all --train-size all --test-size all --seq-stride 4 --epochs 200 --batch-size 256 --hidden-dim 192 --noise-dim 96 --num-layer 3 --pre-additive --index-dim 96 --lr 0.001 --weight-decay 0.0001 --prediction-samples 800 --checkpoint-every 10 --device cuda --skip-assertions --out-dir runs/real_data_diagnostics/log10_ccn/paper/sweep/D_lowlr_preadd
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.154179` |
| median abs error | `0.188663` |
| 90% interval coverage | `0.450621` |
| 50% interval coverage | `0.184161` |
| mean 90% interval width | `0.270002` |
| mean 50% interval width | `0.109349` |
