...
```bash
python experiments/real_data_diagnostic.py --target ccn --log-ccn --split paper --max-samples all --train-size all --test-size all --seq-stride 1 --epochs 120 --batch-size 256 --hidden-dim 192 --noise-dim 96 --num-layer 3 --pre-additive --index-dim 96 --lr 0.003 --weight-decay 0.0 --prediction-samples 800 --checkpoint-every 10 --device cuda --skip-assertions --out-dir runs/real_data_diagnostics/log10_ccn/paper/sweep/A_full_preadd
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.158648` |
| median abs error | `0.182731` |
| 90% interval coverage | `0.306522` |
| 50% interval coverage | `0.132609` |
| mean 90% interval width | `0.171505` |
| mean 50% interval width | `0.068227` |
