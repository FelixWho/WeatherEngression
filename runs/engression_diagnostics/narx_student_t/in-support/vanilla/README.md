# Engression Diagnostic Run: NARX Student-t / in-support / vanilla
...
```bash
python experiments/engression_diagnostic.py --model narx_student_t --engression-model vanilla -d 12 --num-samples 5000 --train-size 4000 --test-size 500 --split in-support --epochs 120 --batch-size 512 --hidden-dim 192 --noise-dim 96 --lr 0.003 --prediction-samples 800 --skip-assertions
```
...
| Metric | Value |
|---|---:|
| mean quantile MAE | `0.259803` |
| q05 MAE | `0.301397` |
| q50 MAE | `0.199691` |
| q95 MAE | `0.278321` |
| predicted 90% interval coverage | `0.698000` |
| true 90% interval coverage on realized y | `0.920000` |
| mean predicted 90% interval width | `0.881841` |
| mean true 90% interval width | `1.295003` |
| width ratio | `0.680957` |
