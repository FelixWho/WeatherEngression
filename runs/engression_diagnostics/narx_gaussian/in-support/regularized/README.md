# Engression Diagnostic Run: NARX Gaussian / in-support / regularized
...
```bash
python experiments/engression_diagnostic.py --model narx_gaussian --engression-model regularized -d 6 --num-samples 5000 --train-size 4000 --test-size 500 --window 12 --epochs 120 --batch-size 512 --hidden-dim 192 --noise-dim 96 --lr 0.003 --weight-decay 0.003 --prediction-samples 800 --skip-assertions
```
...
| Metric | Value |
|---|---:|
| mean quantile MAE | `0.159418` |
| q05 MAE | `0.197947` |
| q50 MAE | `0.106462` |
| q95 MAE | `0.173845` |
| predicted 90% interval coverage | `0.908000` |
| true 90% interval coverage on realized y | `0.892000` |
| mean predicted 90% interval width | `1.528952` |
| mean true 90% interval width | `1.333020` |
| width ratio | `1.146984` |
