...
```bash
python experiments/real_data_diagnostic.py --target ccn --log-ccn --split paper --max-samples all --train-size all --test-size all --seq-stride 1 --epochs 120 --batch-size 256 --hidden-dim 192 --noise-dim 96 --num-layer 3 --stonet-head --lr 0.003 --weight-decay 0.0 --prediction-samples 800 --checkpoint-every 10 --device cuda --skip-assertions --out-dir runs/real_data_diagnostics/log10_ccn/paper/sweep/A_full_stonet
```
...
| Metric | Value |
|---|---:|
| energy score (CRPS, lower better) | `0.151244` |
| median abs error | `0.178504` |
| 90% interval coverage | `0.367702` |
| 50% interval coverage | `0.149689` |
| mean 90% interval width | `0.198266` |
| mean 50% interval width | `0.079065` |
